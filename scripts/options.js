    ...
    2: [function(require, module, exports) {
        ...
        var _ext = require("./utils/ext"),
            ...
            verifyCallback = function(response) {
                recaptchaKey = response, fetch(url + "sendTrustedSources", {
                    method: "post",
                    body: JSON.stringify({
                        trusted_sources: selected_sources,
                        captcha_response: recaptchaKey
                    })
                })
                    .then(function(resp) {
                        return resp.json()
        ...
        window.verifyCallback = verifyCallback, window.errorCallback = errorCallback, window.expiredCallback = expiredCallback,
            function() {
                (0, _jquery2["default"])(document)
                    .ready(function() {
                        (0, _jquery2["default"])("#func_demo")
                            .mouseenter(function(e) {
                                var rightX = (0, _jquery2["default"])(this)[0].offsetTop + 5,
                                    rightY = (0, _jquery2["default"])(this)[0].offsetLeft + (0, _jquery2["default"])(this)[0].offsetWidth - 35;
                                (0, _jquery2["default"])(".right_surfsafe_overlay")
                                    .css({
                                        top: rightX,
                                        left: rightY,
                                        cursor: "auto",
                        ...
                        return walkthrough = {
                            index: 0,
                            nextScreen: function() {
                                if (console.log("heeloo"), this.index < this.indexMax()) return this.index++, this.updateScreen()
                            },
                            prevScreen: function() {
                                if (this.index > 0) return this.index--, this.updateScreen()
                            },
                            updateScreen: function() {
                                return this.reset(), this.goTo(this.index), this.setBtns()
                            },
                            setBtns: function() {
                                var $lastBtn, $nextBtn, $prevBtn;
                                return $nextBtn = (0, _jquery2["default"])(".next-screen"), $prevBtn = (0, _jquery2["default"])(".prev-screen"), $lastBtn = (0, _jquery2["default"])(".finish"), walkthrough.index === walkthrough.indexMax() ? ($nextBtn.hide(), $prevBtn.prop("disabled", !1), $lastBtn.addClass("active")
                                    .prop("disabled", !1)) : 0 === walkthrough.index ? ($nextBtn.prop("disabled", !1), $prevBtn.prop("disabled", !0), $lastBtn.removeClass("active")
                                    .prop("disabled", !0)) : ($nextBtn.prop("disabled", !1), $prevBtn.prop("disabled", !1), $lastBtn.removeClass("active")
                                    .prop("disabled", !0))
                            },
                            goTo: function(index) {
                                2 == index && (0, _jquery2["default"])(".walkthrough")
                                    .css({
                                        height: "600px"
                                    }), 4 == index && ((0, _jquery2["default"])(".walkthrough-footer")
                                    .hide(), (0, _jquery2["default"])(".walkthrough")
                                    .css({
                                        height: "600px"
                                    })), (0, _jquery2["default"])(".screen")
                                    .eq(index)
                                    .addClass("active")
                            },
                            reset: function() {
                                return (0, _jquery2["default"])(".screen")
                                    .removeClass("active")
                            },
                            indexMax: function() {
                                return (0, _jquery2["default"])(".screen")
                            ...
                            closeModal: function() {
                                var _this = this;
                                return (0, _jquery2["default"])(".walkthrough, .shade")
                                    .removeClass("reveal"), setTimeout(function() {
                                    return (0, _jquery2["default"])(".walkthrough, .shade")
                                        .removeClass("show"), _this.index = 0, _this.updateScreen()
                                }, 200)
                            },
                            openModal: function() {
                                return (0, _jquery2["default"])(".walkthrough, .shade")
                                    ...
                                    return (0, _jquery2["default"])(".walkthrough, .shade")
                                        .addClass("reveal")
                                }, 200), this.updateScreen()
                            }
                        }, (0, _jquery2["default"])(".next-screen")
                            .click(function() {
                                return walkthrough.nextScreen()
                            }), (0, _jquery2["default"])(".prev-screen")
                            .click(function() {
                            ...
                            }), walkthrough.openModal(), fetch(url + "getAllSources")
                            .then(function(resp) {
                                return resp.json()
                            })
                            .then(function(data) {
                                for (var sources = data.sources, i = 0; i < sources.length; i++)(0, _jquery2["default"])(".trusted-sources")
                                    .append('<div class="news_icon" style="z-index:9000; height:130px;">\n          <img class=\'ss_source\' src=' + sources[i].image_src + ' style="border-radius: 20%; z-index: 9000; position:relative; -webkit-filter: grayscale(100%);-moz-filter: grayscale(100%); -o-filter: grayscale(100%); -ms-filter: grayscale(100%); filter: grayscale(100%); " width=80px value=' + sources[i].position + '>\n          <text style="color:grey; text-overflow: ellipsis; overflow: hidden; max-width: 100px; max-height: 35px;">' + sources[i].media_name + "</text></div>");
                                (0, _jquery2["default"])(".ss_source")
                                    .click(function(e) {
                                        setTimeout(function() {
                                            0 == selected_sources.length ? (0, _jquery2["default"])(".walkthrough-footer")
                                                .hide() : (0, _jquery2["default"])(".walkthrough-footer")
                                                .show()
                                        }, 500);
                                        var value = (0, _jquery2["default"])(this)
                                            .attr("value");
                                        if (selected_sources.includes(value)) {
                                            var i = selected_sources.indexOf(value);
                                            i != -1 && selected_sources.splice(i, 1), (0, _jquery2["default"])(this)
                                                .css({
                                        ...
                                        } else selected_sources.push(value), (0, _jquery2["default"])(this)
                                            .css({
