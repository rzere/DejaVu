! function() {
    ...
    3: [function(require, module, exports) {
        ...
        function mouseLeave(e) {
            e.relatedTarget != dejavuShadowHost && (right_overlay.hide(), left_overlay.hide())
        }
        function mouseEnter(e) {
            var elem = (0, _jquery2["default"])(this);
            if (!(elem[0].src == document.location.href || document.location.href.includes("youtube.com") || document.location.href.includes("robhat.com") || document.location.href.includes("getdejavu.com"))) {
                var leftX = void 0,
                    leftY = void 0,
                    rightX = void 0,
                    rightY = void 0,
        ...
        function sendReport() {
            ...
            report_modal.find("#dejavu_propaganda")
                .prop("checked") && (report_object.report_type = "Propaganda"), report_modal.find("#dejavu_misleading")
                .prop("checked") && (report_object.report_type = "Misleading"), report_modal.find("#dejavu_photoshopped")
        ...
        var _ext = require("./utils/ext"),
            ...
            url = (require("fs"), "https://python-dot-dejavu-rbl.appspot.com/"),
            auth_token = "",
            collected_images = [],
            current_url = "",
            images_data = [],
        ...
        var dejavuShadowHost = document.createElement("div");
        dejavuShadowHost.classList.add("ss-shadow-host");
        var shadowRoot = void 0;
        shadowRoot = "function" == typeof dejavuShadowHost.attachShadow ? dejavuShadowHost.attachShadow({
            mode: "open"
        }) : dejavuShadowHost, shadowRoot.innerHTML = frag, document.body.appendChild(dejavuShadowHost);
        var left_overlay = (0, _jquery2["default"])(shadowRoot.querySelector(".left_dejavu_overlay")),
            right_overlay = (0, _jquery2["default"])(shadowRoot.querySelector(".right_dejavu_overlay")),
            report_modal = (0, _jquery2["default"])(shadowRoot.querySelector("#dejavuReport")),
            sidebar = (0, _jquery2["default"])(shadowRoot.querySelector("#dejavuSidenav"));
