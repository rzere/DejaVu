    ...
    3: [function(require, module, exports) {
        ...
        function openReport() {
            ...
            report_modal.css({
                ...
                //.click(sendReport)
                .click(function(){
                    alert( "Thank you for tagging this image!" );
                })
        }
        function sendReport() {
            var img_data = _jquery2["default"].grep(images_data, function(e) {
